...
async function apidata(city){
    var list=await fetch(`http://api.weatherapi.com/v1/forecast.json?key= 57b5036cff3b43699b202240232002&q=${city}&days=3&aqi=no&alerts=no`)
